...
getImagesFromMeal(urlRecetaBusqueda)
        .then((data) => {
            ...
            document.querySelector(".Ingremg1").innerHTML = `${data.strIngredient1}`;
            document.querySelector(".Ingremg2").innerHTML = `${data.strIngredient2}`;
            document.querySelector(".Ingremg3").innerHTML = `${data.strIngredient3}`;
            document.querySelector(".Ingremg4").innerHTML = `${data.strIngredient4}`;
